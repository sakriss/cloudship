...
- (void)performRequestForResource:(NSString *)resource method:(AWFRequestMethod)httpMethod options:(nullable id)options encoding:(AWFParameterEncoding)encoding mappingClass:(Class)mappingClass sourceObject:(nullable id)sourceObject completion:(AWFApiEndpointCompletionBlock)completionBlock;
...
- (void)performRequestForResource:(NSString *)resource method:(AWFRequestMethod)httpMethod options:(nullable id)options expires:(NSTimeInterval)expires encoding:(AWFParameterEncoding)encoding mappingClass:(Class)mappingClass sourceObject:(nullable id)sourceObject completion:(AWFApiEndpointCompletionBlock)completionBlock;
- (NSDictionary *)filterEncodedObject:(NSDictionary *)encodedObject ofClass:(Class)klass forMethod:(AWFRequestMethod)method;

- (AWFParameterEncoding)defaultEncodingForMethod:(AWFRequestMethod)method;
