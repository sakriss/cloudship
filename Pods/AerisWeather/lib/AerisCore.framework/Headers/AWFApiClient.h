...
- (AWFRequest *)request:(NSString *)URLString
				 method:(AWFRequestMethod)method
			 parameters:(nullable id)parameters
			 completion:(AWFApiRequestCompletionBlock)completionBlock;

- (AWFRequest *)request:(NSString *)URLString
				 method:(AWFRequestMethod)method
			 parameters:(nullable id)parameters
			   encoding:(AWFParameterEncoding)encoding
			 completion:(AWFApiRequestCompletionBlock)completionBlock;
