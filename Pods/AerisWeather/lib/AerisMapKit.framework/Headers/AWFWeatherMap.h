 ...
 */
@property (nullable, nonatomic, unsafe_unretained) id mapViewDelegate;
 ...
 */
@property (readonly, nonatomic) NSArray<AWFMapLayer> *activeLayerTypes;
 ...
 */
@property (nullable, nonatomic, unsafe_unretained) id<AWFWeatherMapDelegate> delegate;
 ...
 */
@property (nullable, nonatomic, unsafe_unretained) id<AWFWeatherMapDataSource> dataSource;
 ...
 */
+ (NSArray<NSDictionary<NSString *, NSString *> *> *)supportedForecastModels;
