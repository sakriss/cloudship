 ...
 */
@property (nonatomic, strong, nullable) AWFWeatherMap *weatherMap;
...
@property (unsafe_unretained, nonatomic, nullable) id<AWFMapOptionsViewControllerDelegate> delegate;
