...
@property (nonatomic, unsafe_unretained, nullable) id<AWFDataAnimationDataSource> dataSource;

/**
 The object that acts as the data source of the receiving animation.
 */
@property (nonatomic, unsafe_unretained, nullable) id<AWFDataAnimationDelegate> delegate;
