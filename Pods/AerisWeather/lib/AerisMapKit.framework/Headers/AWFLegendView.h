...
@protocol AWFLegendViewDelegate;
...
@property (nonatomic, unsafe_unretained) id<AWFLegendViewDelegate> delegate;
...
/**
 The `AWFLegendViewDelegate` protocol defines a set of optional methods that you can use to receive messages related
 to changes to the legend view.
 */
@protocol AWFLegendViewDelegate <NSObject>
@optional

/**
 Tells the delegate the legend view has presented.

 @param legendView The legend view that was presented
 */
- (void)legendViewDidPresent:(AWFLegendView *)legendView;

/**
 Tells the delegate the legend view has been dismissed.

 @param legendView The legend view that was dismissed
 */
- (void)legendViewDidDismiss:(AWFLegendView *)legendView;
