...
@class AWFAnimation, AWFAnimationTimeline, AWFMapCoordinateBounds;
 ...
 */
- (BOOL)animation:(AWFAnimation *)animation shouldLoadDataForBounds:(AWFMapCoordinateBounds *)bounds;
...
/**
 ...
 @see AWFImageAnimation, AWFDataAnimation
 */
...
- (void)animation:(AWFAnimation *)animation didFailLoadingWithError:(NSError *)error;
 ...
 */
@property (nonatomic, strong, nullable) NSDate *fromTime;

/**
 Ending date for the animation.
 */
@property (nonatomic, strong, nullable) NSDate *toTime;
 ...
 */
@property (readonly, nonatomic, assign) NSTimeInterval totalTime;

/**
 Date of the animation's current position.
 */
@property (readonly, nonatomic, strong, nullable) NSDate *currentTime;

/**
 A Boolean value indicating if this animation contains a future time period.
 */
@property (readonly, nonatomic) BOOL containsFutureTime;

/**
 The parent timeline animation controlling the animation, if any.
 */
@property (nonatomic, strong, nullable) AWFAnimationTimeline *timeline;

/**
 The coordinate bounds for the current data being animated.
 */
@property (nonatomic, strong) AWFMapCoordinateBounds *currentBoundsForData;
...
/**
 Returns whether the animation is currently enabled. When the value is `NO`, the animation will not perform playback individually nor within the context
 of a grouped timeline animation.
 */
 ...
 */
@property (nonatomic, assign, nullable) id<AWFAnimationDataSource> dataSource;

/**
 The object that acts as the delegate of the receiving animation.
 *
 The delegate must adopt the `AWFAnimationDelegate` protocol.
 */
@property (nonatomic, assign, nullable) id<AWFAnimationDelegate> delegate;
